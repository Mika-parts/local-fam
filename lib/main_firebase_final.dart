...
void main() async {
  ...
  runApp(const FamAgendaFirebaseFinalApp());
}

class FamAgendaFirebaseFinalApp extends StatelessWidget {
  const FamAgendaFirebaseFinalApp({super.key});
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        theme: _buildTheme(),
        home: const AuthWrapperFirebaseFinal(),
      ),
    );
  }
...
class AuthWrapperFirebaseFinal extends StatelessWidget {
  const AuthWrapperFirebaseFinal({super.key});
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          ...
                          '• Revenez dans l\'app régulièrement',
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () {
                          ...
                          Navigator.of(context).pushAndRemoveUntil(
                            MaterialPageRoute(builder: (_) => const AuthWrapperFirebaseFinal()),
                            (route) => false,
                          );
                        },
